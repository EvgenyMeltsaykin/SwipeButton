...
import ru.kontur.swipe.button.swipeButton.Anchor
import ru.kontur.swipe.button.swipeButton.SwipeButton

@Composable
fun ComposableSwipeButton(modifier: Modifier) {
    ...
    SwipeButton(
        ...
        centerContent = { progress, currentAnchor ->
            ...
            Box(
                ...
                AnimatedVisibility(
                    ...
                    Text(
                        modifier = Modifier.graphicsLayer { alpha = correctProgress.coerceAtLeast(0.4f) },
                        text = "Принять",
        ...
        endContent = { progress, currentAnchor ->
            ...
            Row {
                Icon(
                    modifier = Modifier.graphicsLayer { alpha = 1 - correctProgress },
